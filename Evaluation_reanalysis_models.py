...
((RMSE_tile_temp_05|RMSE_tile_temp_95|RMSE_tile_wind_95)/(RMSE_tile_temp_01|RMSE_tile_temp_99|RMSE_tile_wind_99)/(RMSE_tile_temp_global|RMSE_tile_wind_global)).savefig(r'C:\Users\leool650\OneDrive - Uppsala universitet\Desktop\Alvex_py\Model_comparison\fig\tile_tot_reanalysis.pdf', format='pdf')
...
pl_te_1_00=RMSE_tail_plot(dat_temp_1[24], dat_temp_1[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_co_1_05=RMSE_tail_plot(dat_temp_1[24], dat_temp_1[25], quant=0.05, greater=False, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wa_1_95=RMSE_tail_plot(dat_temp_1[24], dat_temp_1[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wi_1_00=RMSE_tail_plot(dat_wind_1[24], dat_wind_1[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)
pl_wi_1_95=RMSE_tail_plot(dat_wind_1[24], dat_wind_1[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)


pl_te_3_00=RMSE_tail_plot(dat_temp_3[24], dat_temp_3[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_co_3_05=RMSE_tail_plot(dat_temp_3[24], dat_temp_3[25], quant=0.05, greater=False, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wa_3_95=RMSE_tail_plot(dat_temp_3[24], dat_temp_3[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wi_3_00=RMSE_tail_plot(dat_wind_3[24], dat_wind_3[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)
pl_wi_3_95=RMSE_tail_plot(dat_wind_3[24], dat_wind_3[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)


pl_te_5_00=RMSE_tail_plot(dat_temp_5[24], dat_temp_5[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_co_5_05=RMSE_tail_plot(dat_temp_5[24], dat_temp_5[25], quant=0.05, greater=False, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wa_5_95=RMSE_tail_plot(dat_temp_5[24], dat_temp_5[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wi_5_00=RMSE_tail_plot(dat_wind_5[24], dat_wind_5[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)
pl_wi_5_95=RMSE_tail_plot(dat_wind_5[24], dat_wind_5[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)

    
pl_te_7_00=RMSE_tail_plot(dat_temp_7[24], dat_temp_7[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_co_7_05=RMSE_tail_plot(dat_temp_7[24], dat_temp_7[25], quant=0.05, greater=False, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wa_7_95=RMSE_tail_plot(dat_temp_7[24], dat_temp_7[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wi_7_00=RMSE_tail_plot(dat_wind_7[24], dat_wind_7[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)
pl_wi_7_95=RMSE_tail_plot(dat_wind_7[24], dat_wind_7[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)


pl_te_10_00=RMSE_tail_plot(dat_temp_10[24], dat_temp_10[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_co_10_05=RMSE_tail_plot(dat_temp_10[24], dat_temp_10[25], quant=0.05, greater=False, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wa_10_95=RMSE_tail_plot(dat_temp_10[24], dat_temp_10[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False)
pl_wi_10_00=RMSE_tail_plot(dat_wind_10[24], dat_wind_10[25], quant=0.00, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)
pl_wi_10_95=RMSE_tail_plot(dat_wind_10[24], dat_wind_10[25], quant=0.95, greater=True, HRES_ground=True, operational_comp=False, fixed_number=False, guide_true=True)
